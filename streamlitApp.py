...
st.caption(
        ...
        # Caching the modelfor faster loading 
        @st.cache_resource 
        ...
        # When the submit button is clicked, call the wait time predictorfunction and display the predicted wait time in the output container.
        if submit:
        ...
        # Define a sample datasetfor demonstration purposes.
        data = {
